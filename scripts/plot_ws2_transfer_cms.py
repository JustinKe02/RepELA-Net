"""
Replot WS2 transfer confusion matrices in the same SCI style as gen_paper_figures.py.

Outputs:
  - output/paper_figures/cm_transfer_ws2_scratch.png
  - output/paper_figures/cm_transfer_ws2_ft_resethead.png
"""
...
GT_DIR = ROOT / "other data" / "WS2_data" / "ann_dir" / "test"
PRED_JOBS = [
    ("cm_transfer_ws2_scratch", ROOT / "output" / "finetune_ws2_scratch" / "test_preds"),
    ("cm_transfer_ws2_ft_resethead", ROOT / "output" / "finetune_ws2_r2_resethead" / "test_preds"),
]
...
def main():
    ...
    for name, pred_dir in PRED_JOBS:
